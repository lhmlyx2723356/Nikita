...
namespace Nikita.Core
{
    public class DateHelper
    {
        ...
        #endregion public static string GetDayOfWeek(string dayOfWeek) 获得数字星期几
        ...
        #endregion public static int GetDayOfWeek(string dayOfWeek, bool chinese) 获得星期几
      ...
      */
        ...
        #endregion 将输入的字符串转化为日期。如果字符串的格式非法，则返回当前日期
