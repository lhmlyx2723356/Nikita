...
namespace Nikita.Core
{
    ...
    public sealed class ConvertHelper
    {
        ...
        /// <summary>实现各进制数间的转换。ConvertBase("15",10,16)表示将十进制数15转换为16进制的数。
        ///
        /// </summary>
        ...
        /// <summary>使用指定字符集将byte[]转换成string
        ///
        /// </summary>
        /// <param name="bytes">要转换的字节数组</param>
        /// <param name="encoding">字符编码</param>
        ...
        /// <summary> 将数据转换为单精度浮点型  转换失败 返回默认值
        ///
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="data">数据</param>
        ...
        /// <summary> 将数据转换为单精度浮点型   转换失败返回默认值
        ///
        /// </summary>
        /// <param name="data">数据</param>
        /// <param name="defValue">默认值</param>
        ...
        /// <summary>将数据转换为双精度浮点型   转换失败返回默认值
        ///
        /// </summary>
        ...
        /// <summary>将数据转换为双精度浮点型,并设置小数位   转换失败返回默认值
        ///
        /// </summary>
        /// <typeparam name="T">数据的类型</typeparam>
        /// <param name="data">要转换的数据</param>
        ...
        /// <summary>将数据转换为Decimal  转换失败返回默认值
        ///
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="data">数据</param>
        ...
        /// <summary>将数据转换为Decimal  转换失败返回 默认值
        ///
        /// </summary>
        /// <param name="data">数据</param>
        /// <param name="defValue">默认值</param>
        ...
        /// <summary>将数据转换为DateTime  转换失败返回默认值
        ///
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="data">数据</param>
        ...
        /// <summary>将数据转换为DateTime  转换失败返回 默认值
        ///
        /// </summary>
        /// <param name="data">数据</param>
        /// <param name="defValue">默认值</param>
