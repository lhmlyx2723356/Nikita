...
namespace Nikita.Core
{
    public class StringUtil
    {
        ...
        /// <summary> 获取子查询条件，这需要处理多个模糊匹配的字符
        ///
        /// </summary>
        ...
        #endregion public static string GetSearchString(string searchValue, string allLike = null) 获取查询字符串
        ...
        #endregion public static bool Exists(string[] ids, string targetString) 判断是否包含的方法
        ...
        public static string[] Concat(params string[][] ids)
        {
            ...
            {
                returnValues[key] = enumerator.Key.ToString();
                key++;
            }
            return returnValues;
        }
        ...
        #endregion 从目标数组中去除某个值 public static string[] Remove(string[] ids, string id)
        ...
        #endregion public static string RepeatString(string targetString, int repeatCount) 重复字符串
