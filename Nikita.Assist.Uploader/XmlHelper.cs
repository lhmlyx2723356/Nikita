...
namespace Nikita.Assist.Uploader
{
    ...
    public class XmlHelper
    {
        ...
        public string ReadValue(string XmlPathNode, string XmlNextPathNode)
        {
            ...
            try
            {
                XmlNode xn = objXmlDoc.SelectSingleNode(XmlPathNode).SelectSingleNode(XmlNextPathNode);
                value =   xn.InnerText  ;
            }
            catch (Exception ex)
            {
        ...
        {
            objXmlDoc.SelectSingleNode(XmlPathNode).SelectSingleNode(XmlNextPathNode).InnerText = Content;
        }
        /// <summary>删除节点
        /// 
        /// </summary>
