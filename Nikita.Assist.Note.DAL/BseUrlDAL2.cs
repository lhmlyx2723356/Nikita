...
{
    /// <summary>BseUrl2表数据访问类
    /// 作者:Luhm
    /// 创建时间:2016-06-19 11:46:12
    /// </summary>
    public partial class BseUrlDAL2 : IBseDAL<BseUrl2>
    {
        public BseUrlDAL2()
        { }
        /// <summary>增加一条数据
        ...
        /// 
        /// </summary>
        public Nikita.Assist.Note.Model.BseUrl2 ReaderBind(IDataReader dataReader)
        {
            Nikita.Assist.Note.Model.BseUrl2 model = new Nikita.Assist.Note.Model.BseUrl2();
            object ojb;
            ojb = dataReader["Id"];
