...
public class INIOperationHelper
{
    ...
    public static string[] IniGetAllItems(string iniFile, string section)
    {
        ...
        const uint maxBuffer = 32767; //默认为32767
        ...
        uint bytesReturned = GetPrivateProfileSection(section, pReturnedString, maxBuffer, iniFile);
    ...
    public static string[] IniGetAllSectionNames(string iniFile)
    {
        ...
        //申请内存
        IntPtr pReturnedString = Marshal.AllocCoTaskMem((int)maxBuffer * sizeof(char));
        uint bytesReturned = GetPrivateProfileSectionNames(pReturnedString, maxBuffer, iniFile);
        if (bytesReturned != 0)
        {
            //读取指定内存的内容
    ...
    public static bool IniWriteValue(string iniFile, string section, string key, string value)
    {
        ...
        bool flag = WritePrivateProfileString(section, key, value, iniFile);
        return flag;
    }
