...
namespace Nikita.Assist.DBManager
{
    public class NPOIHelper
    {
        ...
        public static string ExportToExcel(DataSet sourceDs, string strFilePath = null)
        {
            if (string.IsNullOrEmpty(strFilePath))
            {
                strFilePath = GetSaveFilePath();
            }

            if (string.IsNullOrEmpty(strFilePath)) return null;

            bool isCompatible = GetIsCompatible(strFilePath);
        ...
        /// <param name="strFilePath"></param>
        /// <returns>Excel工作表</returns>
        public static string ExportToExcel(DataTable sourceTable, string strSheetName = "result", string strFilePath = null)
        {
