...
namespace Nikita.Assist.DBManager
{
    public class ExcelHelper
    {
        ...
        /////
        ///// </summary>
        ///// <param name="grdTable">要导出的dataGridView控件</param>
        ///// <param name="sheetName">sheet表名</param>
        //public static void ExportToExcel(GridView grdTable, string sheetName)
        //{
        ...
        //    grdTable.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.False;
        //    HSSFWorkbook workbook = new HSSFWorkbook();
        //    ISheet sheet = workbook.CreateSheet(sheetName);
        //    IRow rowHead = sheet.CreateRow(0);

        //    //填写表头
        //    for (int i = 0; i < grdTable.Columns.Count; i++)
        //    {
        //        rowHead.CreateCell(i, CellType.String).SetCellValue(grdTable.Columns[i].Caption);
        //    }
        //    //填写内容
        //    for (int i = 0; i < grdTable.RowCount; i++)
        //    {
        //        IRow row = sheet.CreateRow(i + 1);
        //        for (int j = 0; j < grdTable.Columns.Count; j++)
        //        {
        //            row.CreateCell(j, CellType.String).SetCellValue(grdTable.GetDataRow(i)[j].ToString());
        //        }
        //    }
        ...
        ///
        /// </summary>
        /// <param name="grdTable">要导出的DataTable</param>
        /// <param name="sheetName">sheet表名</param>
