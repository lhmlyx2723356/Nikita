...
namespace Nikita.Assist.DBManager.DAL
{
    ...
    public partial class DbConnectDAL
    {
        ...
        ///
        /// </summary>
        public int Add(Nikita.Assist.DBManager.Model.DbConnect model)
        {
            ...
            strSql.Append("@IP, @User, @Pwd, @CreateDate, @Remark  )");
            SQLiteHelper h = new SQLiteHelper(GlobalHelp.DatabaseManagerDB);
        ...
        ///
        /// </summary>
        public List<Nikita.Assist.DBManager.Model.DbConnect> GetListArray(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM DbConnect ");
            ...
            List<Nikita.Assist.DBManager.Model.DbConnect> list = new List<Nikita.Assist.DBManager.Model.DbConnect>();
            SQLiteHelper h = new SQLiteHelper(GlobalHelp.DatabaseManagerDB);
            h.CreateCommand(strSql.ToString());
        ...
        ///
        /// </summary>
        public List<Nikita.Assist.DBManager.Model.DbConnect> GetListArray(string fileds, string order, string ordertype, int PageSize, int PageIndex, string strWhere)
        {
            SQLiteHelper h = new SQLiteHelper(GlobalHelp.DatabaseManagerDB);
            DataTable dt = h.FengYe("DbConnect", fileds, order, ordertype, strWhere, PageSize, PageIndex);
            List<Nikita.Assist.DBManager.Model.DbConnect> list = new List<Nikita.Assist.DBManager.Model.DbConnect>();
        ...
        ///
        /// </summary>
        public Nikita.Assist.DBManager.Model.DbConnect GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            h.CreateCommand(strSql.ToString());
            h.AddParameter("@id", id);
            Nikita.Assist.DBManager.Model.DbConnect model = null;
            using (IDataReader dataReader = h.ExecuteReader())
            {
                if (dataReader.Read())
                {
        ...
        ///
        /// </summary>
        public Nikita.Assist.DBManager.Model.DbConnect GetModelByCond(string cond)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from DbConnect ");
            if (!string.IsNullOrEmpty(cond))
        ...
        ///
        /// </summary>
        public Nikita.Assist.DBManager.Model.DbConnect ReaderBind(IDataReader dataReader)
        {
            Nikita.Assist.DBManager.Model.DbConnect model = new Nikita.Assist.DBManager.Model.DbConnect();
            object ojb;
            ojb = dataReader["id"];
        ...
        ///
        /// </summary>
        public bool Update(Nikita.Assist.DBManager.Model.DbConnect model)
        {
            StringBuilder strSql = new StringBuilder();
