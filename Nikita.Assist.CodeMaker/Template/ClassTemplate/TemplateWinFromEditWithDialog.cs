...
{
    public class TemplateWinFromEditWithDialog : CodeMakeBulider
    {
        ...
        {
            string strFrmClassName = "Frm" + parameter.ClassName + "SimpleDialog";
            ...
            sb.AppendLine("        public " + strFrmClassName + " (" + strModelName + "  model" + strModelName + ", List<" + strModelName + ">   lst" + strModelName + ")");
            sb.AppendLine("        {");
            ...
            sb.AppendLine("            if (  model" + strModelName + " != null)");
            sb.AppendLine("            {");
            sb.AppendLine("                this.dataNavigator.Visible = true;");
            sb.AppendLine("                " + strGlobalModelName + " =   model" + strModelName + ";");
            ...
            if (baseParameter is EditDialogParameter)
            {
                EditDialogParameter para = baseParameter as EditDialogParameter;
