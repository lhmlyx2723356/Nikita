...
{
    public partial class FrmWinFormGen : DockContentEx
    {
        #region 常量、变量
        /// <summary>数据库结构
        /// 数据库结构
        ...
        string m_strQueryColumns;
        string m_strShowColumns;
        string m_strEditColumns;
        string m_strCheckInputColumns;
        string m_strDontRepeatColumns;
