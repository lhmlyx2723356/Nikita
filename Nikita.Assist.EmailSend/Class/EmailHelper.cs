...
namespace Nikita.Assist.EmailSend
{
    public class EmailHelper
    {
        ...
        /// <returns></returns>
        public bool Send(string subject, string body, string to, string mailFrom, string mailFromName, string mailDomain, string mailServerUserName, string mailServerPassWord, List<string> lstAttemt)
        {
            ...
            try
            {
                ...
                if (lstAttemt != null)
                {
                    foreach (string strAttemt in lstAttemt)
                    {
                        ...
                        //string strMimeName = MimeMapping.GetMimeMapping(strAttemt);
                        //Attachment attemt = Attachment.CreateAttachmentFromString(strAttemt, strMimeName);
                        Attachment attemt = new Attachment(strAttemt);
                        msg.Attachments.Add(attemt);
                    }
                }
