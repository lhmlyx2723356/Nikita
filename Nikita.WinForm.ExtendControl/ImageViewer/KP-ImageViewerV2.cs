    ...
    public partial class KpImageViewer : UserControl
    {
        ...
        public KpImageViewer()
        {
            ...
            try
            {
                ...
                imgStream = a.GetManifestResourceStream("Nikita.WinForm.ExtendControl.Resources.Grab.cur");
                if (imgStream != null)
                {
                ...
                imgStream = a.GetManifestResourceStream("Nikita.WinForm.ExtendControl.Resources.Drag.cur");
                if (imgStream != null)
                {
        ...
        private void btnMode_Click(object sender, EventArgs e)
        {
            ...
            {
                selectMode = true;
                this.btnMode.Image = Nikita.WinForm.ExtendControl.Properties.Resources.btnDrag;
            }
            else
            {
                selectMode = false;
                this.btnMode.Image = Nikita.WinForm.ExtendControl.Properties.Resources.btnSelect;
            }
        }
