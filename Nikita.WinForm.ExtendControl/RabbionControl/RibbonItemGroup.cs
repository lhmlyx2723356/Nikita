...
{
    //[Designer("Nikita.WinForm.ExtendControl.RibbonQuickAccessToolbarDesigner")]
        ...
        IContainsSelectableRibbonItems, IContainsRibbonComponents
    {
        ...
        internal override void SetOwnerPanel(Nikita.WinForm.ExtendControl.RibbonPanel ownerPanel)
        {
        ...
        internal override void SetOwner(Nikita.WinForm.ExtendControl.Ribbon owner)
        {
            base.SetOwner(owner);
        ...
        internal override void SetOwnerTab(Nikita.WinForm.ExtendControl.RibbonTab ownerTab)
        {
