...
namespace Nikita.WinForm.ExtendControl
{
           ...
           : List<RibbonTab>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<Nikita.WinForm.ExtendControl.RibbonTab> items)
        {
        ...
        public new void Insert(int index, Nikita.WinForm.ExtendControl.RibbonTab item)
        {
            item.SetOwner(Owner);
