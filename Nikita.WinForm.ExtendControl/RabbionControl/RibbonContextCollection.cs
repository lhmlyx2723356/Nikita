...
namespace Nikita.WinForm.ExtendControl
{
        ...
        : List<RibbonContext>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<Nikita.WinForm.ExtendControl.RibbonContext> items)
        {
        ...
        public new void Insert(int index, Nikita.WinForm.ExtendControl.RibbonContext item)
        {
            item.SetOwner(Owner);
