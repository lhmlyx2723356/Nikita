...
namespace Nikita.WinForm.ExtendControl
{
        ...
        : List<RibbonPanel>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<Nikita.WinForm.ExtendControl.RibbonPanel> items)
        {
        ...
        public new void Insert(int index, Nikita.WinForm.ExtendControl.RibbonPanel item)
        {
            item.SetOwner(Owner);
            item.SetOwnerTab(OwnerTab);
