...
namespace Nikita.WinForm.ExtendControl
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        /// </summary>
        [Editor("Nikita.WinForm.ExtendControl.Design.OLVColumnCollectionEditor", "System.Drawing.Design.UITypeEditor")]
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public IDragSourceListView DragSource
        {
            get { return this.dragSource; }
            set { this.dragSource = value; }
        }

        private IDragSourceListView dragSource;
...
#pragma warning restore 168
        ...
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("按'{0}'升序"), Localizable(true)]
        ...
        private string menuLabelSortAscending = "按'{0}'升序";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("按'{0}'降序"), Localizable(true)]
        ...
        private string menuLabelSortDescending = "按'{0}'降序";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("按'{0}'过滤"), Localizable(true)]
        ...
        private string menuLabelGroupBy = "按'{0}'过滤";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("锁定分组'{0}'"), Localizable(true)]
        ...
        private string menuLabelLockGroupingOn = "锁定分组'{0}'";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("取消锁定分组'{0}'"), Localizable(true)]
        ...
        private string menuLabelUnlockGroupingOn = "取消锁定分组'{0}'";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("关闭分组"), Localizable(true)]
        ...
        private string menuLabelTurnOffGroups = "关闭分组";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("取消排序"), Localizable(true)]
        ...
        private string menuLabelUnsort = "取消排序";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("列"), Localizable(true)]
        ...
        private string menuLabelColumns = "列";

        /// <summary>
        ///
        /// </summary>
        [Category("Labels - ObjectListView"), DefaultValue("选择列"), Localizable(true)]
        ...
        private string menuLabelSelectColumns = "选择列";

        /// <summary>
        /// Gets or sets the image that will be place next to the Sort Ascending command
        /// </summary>
        static public Bitmap SortAscendingImage = Properties.Resources.SortAscending;

        /// <summary>
        /// Gets or sets the image that will be placed next to the Sort Descending command
        /// </summary>
        static public Bitmap SortDescendingImage = Properties.Resources.SortDescending;
...
#pragma warning restore 168
        ...
        ///
        /// </summary>
        /// <param name="olv">ObjectListView对象</param>
        /// <param name="strInputFilter">过滤内容</param>
        /// <param name="intMatchKind">匹配类型</param>
        public virtual void TimedFilter(string strInputFilter, int intMatchKind = 0)
        {
            TextMatchFilter filter = null;
            if (!String.IsNullOrEmpty(strInputFilter))
            {
                switch (intMatchKind)
                {
                    default:
                        filter = TextMatchFilter.Contains(this, strInputFilter);
                        break;

                    case 1:
                        filter = TextMatchFilter.Prefix(this, strInputFilter);
                        break;

                    case 2:
                        filter = TextMatchFilter.Regex(this, strInputFilter);
                        break;
                }
            }
            // Setup a default renderer to draw the filter matches
            DefaultRenderer = filter == null ? null : new HighlightTextRenderer(filter);
            ...
            //        String.Format("过滤耗时{0}ms", stopWatch.ElapsedMilliseconds);
            //else
            //    this.toolStripStatusLabel1.Text =
            //        String.Format("从 {0} 结果 过滤出 {1} 结果 耗时 {2}ms",
            //                      objects.Count,
            //                      olv.Items.Count,
