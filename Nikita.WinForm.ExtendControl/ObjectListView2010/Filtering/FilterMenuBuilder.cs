...
namespace Nikita.WinForm.ExtendControl
{
    ...
    public class FilterMenuBuilder
    {
        ...
        /// </summary>
        static public string APPLY_LABEL = "应用";//"Apply";

        /// <summary>
        /// Gets or sets the string that labels the Clear All menu item.
        /// Exposed so it can be localized.
        /// </summary>
        static public string CLEAR_ALL_FILTERS_LABEL = "清除所有过滤";// "Clear All Filters";
        ...
        /// Exposed so it can be localized.
        /// </summary>
        static public string FILTERING_LABEL = "过滤";//"Filtering";
        ...
        /// Exposed so it can be localized.
        /// </summary>
        static public string SELECT_ALL_LABEL = "选择所有";//"Select All";
