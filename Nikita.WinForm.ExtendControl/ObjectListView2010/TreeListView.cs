...
namespace Nikita.WinForm.ExtendControl
{
    ...
    {
        private bool _hierarchicalCheckboxes;
        ...
        public TreeListView()
        {
            RevealAfterExpand = true;
            UseWaitCursorWhenExpanding = true;
            this.OwnerDraw = true;
        ...
        {
            get { return this._hierarchicalCheckboxes; }
            set
            {
        ...
        [Category("ObjectListView"),
         ...
         DefaultValue(true)]
        public bool RevealAfterExpand { get; set; }
        ...
        DefaultValue(true)]
        public virtual bool UseWaitCursorWhenExpanding { get; set; }
        ...
        public virtual void GetAllChildrens<T>(object item, ref  List<T> lstChildrens)
        {
            IEnumerable resultEnumerable = GetChildren(item);
            foreach (var child in resultEnumerable)
            {
                T children = (T)child;
                if (!lstChildrens.Contains(children))
                {
                    lstChildrens.Add(children);
                }
                GetAllChildrens(children, ref lstChildrens);
            }
        }

        public virtual void GetAllChildrensWithSelf<T>(object item, ref  List<T> lstChildrens)
        {
            if (lstChildrens == null)
            {
                lstChildrens = new List<T>();
            }

            T itemT = (T)item;
            if (!lstChildrens.Contains(itemT))
            {
                lstChildrens.Add(itemT);
            }
            IEnumerable resultEnumerable = GetChildren(item);
            foreach (var child in resultEnumerable)
            {
        ...
        public virtual void GetAllChildrensWithSelfByCollection<T>(IList lstCollection, ref List<T> lstChildrens)
        {
            foreach (var item in lstCollection)
            {
                GetAllChildrensWithSelf(item, ref lstChildrens);
            }
        }
        ...
        public override void RefreshObjects(IList modelObjects)
        {
            ...
            {
                ArrayList newRoots = EnumerableToArray(this.Roots, false);
                bool changed = false;
        ...
        protected override bool SetObjectCheckedness(object modelObject, CheckState state)
        {
            ...
            ArrayList args = new ArrayList { modelObject };
        ...
        private bool _isRecalculatingHierarchicalCheckBox;
        ...
        protected virtual void RecalculateHierarchicalCheckBoxGraph(IList toCheck)
        {
            ...
            if (_isRecalculatingHierarchicalCheckBox)
                return;

            try
            {
                _isRecalculatingHierarchicalCheckBox = true;
                foreach (object ancestor in CalculateDistinctAncestors(toCheck))
                    this.RecalculateSingleHierarchicalCheckBox(ancestor);
            }
            finally
            {
                _isRecalculatingHierarchicalCheckBox = false;
            }
        }
        ...
        public class Branch
        {
            ...
            {
                get { return this._childBranches; }
                set { this._childBranches = value; }
            }
            ...
            public virtual bool IsFirstBranch
            {
                get
                {
                    return ((this._flags & BranchFlags.FirstBranch) != 0);
                }
                set
                {
                    if (value)
                        this._flags |= BranchFlags.FirstBranch;
                    else
                        this._flags &= ~BranchFlags.FirstBranch;
                }
            }
            ...
            public virtual bool IsLastChild
            {
                get
                {
                    return ((this._flags & BranchFlags.LastChild) != 0);
                }
                set
                {
                    if (value)
                        this._flags |= BranchFlags.LastChild;
                    else
                        this._flags &= ~BranchFlags.LastChild;
                }
            }
            ...
            public virtual bool IsOnlyBranch
            {
                get
                {
                    return ((this._flags & BranchFlags.OnlyBranch) != 0);
                }
                set
                {
                    if (value)
                        this._flags |= BranchFlags.OnlyBranch;
                    else
                        this._flags &= ~BranchFlags.OnlyBranch;
                }
            }
        ...
        public class BranchComparer : IComparer<Branch>
        {
            ...
            {
                return this._actualComparer.Compare(x.Model, y.Model);
            }
        }
        ...
        public class Tree : IVirtualListDataSource, IFilterableDataSource
        {
            ...
            public Tree(TreeListView treeView)
            {
                ...
                this._trunk = new Branch(null, this, null) { IsExpanded = true };
            }
            ...
            {
                get { return this._trunk.Children; }
                set
                {
                    this._trunk.Children = value;
                    foreach (Branch br in this._trunk.ChildBranches)
                        br.RefreshChildren();
                    this.RebuildList();
                }
            }
            ...
            public virtual int Collapse(Object model)
            {
                ...
                this._objectList.RemoveRange(index + 1, count);
            ...
            {
                this._trunk.ExpandAll();
                this.Sort(this._lastSortColumn, this._lastSortOrder);
                return 0;
            }
            ...
            public virtual Branch GetBranch(object model)
            {
                ...
                Branch br;
                this._mapObjectToBranch.TryGetValue(model, out br);
                return br;
            }
            ...
            internal Branch MakeBranch(Branch parent, object model)
            {
                ...
                this._mapObjectToBranch[model] = br;
                return br;
            }
            ...
            protected virtual void InsertChildren(Branch br, int index)
            {
                ...
                this._objectList.InsertRange(index, br.Flatten());
                this.RebuildObjectMap(index);
            }
            ...
            {
                this._objectList = ArrayList.Adapter(this._trunk.Flatten());
                List<Branch> filtered = this._trunk.FilteredChildBranches;
                if (filtered.Count > 0)
                {
            ...
            {
                if (startIndex == 0)
                    this._mapObjectToIndex.Clear();
                for (int i = startIndex; i < this._objectList.Count; i++)
                    this._mapObjectToIndex[this._objectList[i]] = i;
            }
            ...
            {
                ArrayList newRoots = EnumerableToArray(this._treeView.Roots, true);
            ...
            {
                return this._trunk.NumberVisibleDescendents;
            }
            ...
            {
                int index;
                if (model != null && this._mapObjectToIndex.TryGetValue(model, out index))
                    return index;
            ...
            public virtual void RemoveObjects(ICollection modelObjects)
            {
                ...
                {
                    newRoots.Remove(x);
                    this._mapObjectToIndex.Remove(x);
                }
                this.SetObjects(newRoots);
            }
            ...
            public virtual void Sort(OLVColumn column, SortOrder order)
            {
                ...
                foreach (Branch b in this._trunk.ChildBranches)
                    b.IsFirstBranch = false;

                this._trunk.Sort(this.GetBranchComparer());
                this.RebuildList();
            }
            ...
            {
                ArrayList newRoots = EnumerableToArray(this._treeView.Roots, false);
            ...
            protected virtual BranchComparer GetBranchComparer()
            {
                ...
                return new BranchComparer(new ModelObjectComparer(
                    ...
                    this._treeView.SecondarySortColumn == null ? this._lastSortOrder : this._treeView.SecondarySortOrder));
            }
            ...
            internal bool IsFiltering
            {
                get
                {
                    return this._treeView.UseFiltering && (this.modelFilter != null || this.listFilter != null);
                }
            }
            ...
            {
                if (!this._treeView.UseFiltering)
                    return true;
