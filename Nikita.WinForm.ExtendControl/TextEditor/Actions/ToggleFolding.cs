...
// Type: Nikita.WinForm.ExtendControl.Actions.ToggleFolding
...
namespace Nikita.WinForm.ExtendControl.Actions
{
  public class ToggleFolding : AbstractEditAction
  {
    ...
    {
      foreach (FoldMarker foldMarker in textArea.Document.FoldingManager.GetFoldingsWithStart(textArea.Caret.Line))
