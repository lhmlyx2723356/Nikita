...
using Nikita.WinForm.ExtendControl.Collections;
using Nikita.WinForm.ExtendControl.Win32;
using Nikita.WinForm.ExtendControl.General;
using Nikita.WinForm.ExtendControl.Menus;

namespace Nikita.WinForm.ExtendControl.WinControls
{
	...
	[ToolboxBitmap(typeof(Nikita.WinForm.ExtendControl.WinControls.OutlookBar), 
    "Nikita.WinForm.ExtendControl.WinControls.OutlookBar.bmp")]
	public class OutlookBar : System.Windows.Forms.Control
	{
		...
		public OutlookBar()
		{
			...
			// Load drag cursor
           //Assembly myAssembly = Assembly.GetAssembly(Type.GetType("Nikita.WinForm.ExtendControl.WinControls.OutlookBar"));
           //Stream cursorStream = myAssembly.GetManifestResourceStream("Nikita.WinForm.ExtendControl.Properties.Resources.DragCursor.cur");
		    Stream cursorStream = Nikita.WinForm.ExtendControl.Properties.Resources.DragCursor;
