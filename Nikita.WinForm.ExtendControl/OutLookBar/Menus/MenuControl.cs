...
namespace Nikita.WinForm.ExtendControl.Menus
{
	...
	[Designer(typeof(Nikita.WinForm.ExtendControl.Menus.MenuControlDesigner))]
	public class MenuControl : ContainerControl, IMessageFilter
	{
		...
		static MenuControl()
		{
			...
			_menuImages = ResourceUtil.LoadImageListResource(Type.GetType("Nikita.WinForm.ExtendControl.Menus.MenuControl"),
                                                         "Properties.Resources.ImagesMenu",
														 "MenuControlImages",
