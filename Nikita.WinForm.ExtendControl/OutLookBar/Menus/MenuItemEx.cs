...
using Nikita.WinForm.ExtendControl.CommandBars;
...
namespace Nikita.WinForm.ExtendControl.Menus
{
	...
	public class MenuItemEx : MenuItem
	{
		...
		static MenuItemEx()
		{
            ...
            //Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("Nikita.WinForm.ExtendControl.Menus.MenuItemEx"));
            //ResourceManager rm = new ResourceManager("Nikita.WinForm.ExtendControl.Properties.ImagesMenu", thisAssembly);

		    Bitmap glyphs = Nikita.WinForm.ExtendControl.Properties.Resources.Glyphs;
