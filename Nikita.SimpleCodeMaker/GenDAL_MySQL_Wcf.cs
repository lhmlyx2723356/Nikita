...
namespace Nikita.Assist.SimpleCodeMaker
{
    ...
    public class GenDAL_MySQL_Wcf
    {
        ...
        public static string GenAllCode(string ns, string tabname, string classname, string connstr)
        {
            ...
            StreamReader sr = new StreamReader(System.Environment.CurrentDirectory + @"\classtemp\MySQLDALTempWcf.txt");
        ...
        /// <returns></returns>
        internal static string GenMySQLHelper(string ns, string connstr)
        {
            StringBuilder sb = new StringBuilder();
